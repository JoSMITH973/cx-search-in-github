...
app.get('/',(req,res) => {
    ...
    res.send('Enter an username in the url')
})
let searchCondition 
app.get('/:username',(req,res) => {
    ...
    sequelize
        ...
        .then(function(result){
            searchCondition = result[0][0]['login'] || 'undefined'
            console.log(result[0][0]['login'])
            res.send(result[0][0]['login'])
            if(req.params.username==searchCondition) {
                console.log('true')
            }
            else if(searchCondition=='undefined'){
                console.log('false')
            }
        })
